...
Funcionalidade: ObtemListaTed
  ...
  Cenário: Obter lista TED pelo retorna lista não vazia
  ...
  Cenário: Obter lista TED pelo com erro de validação retorna erro
    Dado que eu tenho um Cliente ID inválido
    Quando eu chamo o método ObtemListaTed com esse Cliente ID
    Então um erro de validação é retornado

  Cenário: Obter lista TED pelo Cliente ID retorna lista não vazia
    Dado que eu tenho um Cliente ID válido
    Quando eu chamo o método ObtemListaTed com esse Cliente ID
    Então uma lista não vazia de TEDs é retornada
  ...
  Cenário: Obter lista TED pelo filtrada por status retorna lista não vazia
    ...
    Então uma lista filtrada não vazia de TEDs é retornada

  Cenário: Obter lista TED pelo filtrada por status retorna lista vazia
    Dado que eu tenho um Cliente ID válido e um status sem TEDs associados
    Quando eu chamo o método ObtemListaTed com esse Cliente ID e status
    Então uma lista vazia é retornada

  Cenário: Obter lista TED pelo Cliente ID filtrada por status retorna lista
    Dado que eu tenho um Cliente ID válido e um status específico
    Quando eu chamo o método ObtemListaTed com esse Cliente ID e status
    Então uma lista filtrada de TEDs é retornada
  ...
  Cenário: Obter lista TED pelo filtrada por data de início retorna lista não vazia
  ...
  Cenário: Obter lista TED pelo filtrada por data de início retorna lista vazia
  ...
  Cenário: Obter lista TED pelo filtrada por data de início e data de fim retorna lista não vazia
  ...
  Cenário: Obter lista TED pelo filtrada por data de início e data de fim retorna lista vazia
